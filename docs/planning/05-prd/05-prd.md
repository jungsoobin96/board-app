...
- O-15: F-08 인기 태그 노출 개수 기본값을 20개로 확정할지 사용자 옵션으로 노출할지 — 10 LLD에서 결정.
- O-16: F-10 한국어 주석 커버리지 측정 도구 — grep 룰 기반 자동 측정 vs 수동 리뷰.
- O-17: F-11 반응형 검증을 12 Test Design 카탈로그에 E2E 단일 시나리오로 묶을지 viewport별 분리할지.
- O-18: F-12 README 경고 문구 — 영어/한국어 병기 여부.
- O-19: 평가 기준(RFP §10) 7개 항목을 12 Test Design의 E2E 카탈로그와 1:1 매핑할지 그룹화할지.
